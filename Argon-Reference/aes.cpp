...
uint8_t mul[256][256]; //GF(256) multiplication table, initialized in Init().

void AES_Round(uint8_t* state, uint8_t* subkey)  //SubBytes-ShiftRows-MixColumns-AddRoundKey
{
	uint8_t tmp[4][4];
...
void AES_reduced(int128 &input)
{
	...
	input.i0 = *((uint64_t*)state);
	input.i1 = *((uint64_t*)(state + 8));
